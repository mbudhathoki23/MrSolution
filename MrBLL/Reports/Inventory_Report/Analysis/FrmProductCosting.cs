...
public partial class FrmProductCosting : MrForm
{
    ...
    private void FrmProductCosting_KeyPress(object sender, KeyPressEventArgs e)
    {
    ...
    private void BindGroupItem()
    {
        ...
        var list = new List<GroupBy>
        {
            new(1, "None", "1"),
            new(2, "Product", "2"),
            new(3, "ProductGroup", "3"),
            new(4, "ProductSubgroup", "4"),
            new(5, "Party", "5")
        };
