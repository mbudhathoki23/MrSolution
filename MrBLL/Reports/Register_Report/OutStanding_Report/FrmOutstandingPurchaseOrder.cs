...
public partial class FrmOutstandingPurchaseOrder : MrForm
{
    ...
    public FrmOutstandingPurchaseOrder()
    {
        InitializeComponent();
    }

    private void OutstandingPurchaseOrder_Load(object sender, EventArgs e)
    {
    ...
    private void OutstandingPurchaseOrder_KeyPress(object sender, KeyPressEventArgs e)
    {
