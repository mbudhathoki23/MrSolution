...
public partial class FrmOutstandingPurchaseChallan : MrForm
{
    ...
    public FrmOutstandingPurchaseChallan()
    {
        InitializeComponent();
    }

    private void OutstandingPurchaseChallan_Load(object sender, EventArgs e)
    {
    ...
    private void OutstandingPurchaseChallan_KeyPress(object sender, KeyPressEventArgs e)
    {
    ...
    private void msk_ToDate_Validated(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Report To Date Cann't be Left Blank!");
            msk_ToDate.Focus();
        }
    }
