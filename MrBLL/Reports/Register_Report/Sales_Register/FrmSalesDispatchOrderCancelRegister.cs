...
public partial class FrmSalesDispatchOrderCancelRegister : MrForm
{
    ...
    public FrmSalesDispatchOrderCancelRegister()
    {
        InitializeComponent();
    }

    private void SalesDispatchOrderCancelRegister_Load(object sender, EventArgs e)
    {
    ...
    private void SalesDispatchOrderCancelRegister_KeyPress(object sender, KeyPressEventArgs e)
    {
    ...
    {
        //ClassCode = ObjGlobal.GetClassById("SO_Master", string.Empty);
        //if (string.IsNullOrEmpty(ClassCode))
        //{
        //    if (ObjGlobal._ProjectCode == "07" || ObjGlobal._ProjectCode == "08")
        //    {
        //        MessageBox.Show("Table Code List Not Selected!");
        //    }
        //    else
        //    {
        //        MessageBox.Show("Class Code List Not Selected!");
        //    }
        //    return;
        //}
        //else
