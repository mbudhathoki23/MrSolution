...
public partial class FrmSalesProductTopNwise : MrForm
{
    ...
    public FrmSalesProductTopNwise()
    {
        InitializeComponent();
    }

    private void FrmSalesProductTopNwise_Load(object sender, EventArgs e)
    {
    ...
    private void FrmSalesProductTopNwise_KeyPress(object sender, KeyPressEventArgs e)
    {
