    ...
    public partial class FrmUserRight : Form
    {
        ...
        private void FrmUserRight_Load(object sender, EventArgs e)
        {
            ...
            MrMenu.Items.OfType<ToolStripMenuItem>().Where(i => i.DropDownItems.Count > 0).ForEach(x =>
            {
                ...
                {
                    // Handle the case where Tag is null, for example, by setting menuTag to an appropriate default value.
                    menuTag = "DefaultMenuTag";
                }
        ...
        {
            MrMenu.Items.Clear();
            var menu = new MdiVismaErp().HearderMenuList.Items.OfType<ToolStripMenuItem>();
            MrMenu.Items.AddRange(menu.ToArray());
        }
        public void BindUsers()
        {
            ...
            var dt1 = ExecuteCommand.ExecuteDataSetOnMaster(cmdString).Tables[0];
