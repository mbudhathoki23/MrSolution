...
--------------- account ledgers
UPDATE AMS.GeneralLedger SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL


UPDATE AMS.AccountGroup SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL


---------------- products
UPDATE AMS.Product SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL

UPDATE AMS.ProductUnit SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL


UPDATE AMS.ProductGroup SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL

UPDATE AMS.ProductSubGroup SET SyncGlobalId = NEWID(), SyncRowVersion = 1, SyncCreatedOn = EnterDate, 
SyncOriginId = @localOriginId WHERE SyncGlobalId IS NULL
