<Query Kind="Program">
  <Connection>
    <ID>32f9c30b-1634-4ffe-85ca-fac6842cdd2d</ID>
    <Persist>true</Persist>
    <Server>DESKTOP-2266TC0</Server>
    <Database>MR_ACCOU05</Database>
...
void Main()
{
	...
	{
	 	var classCode = conn.GenerateClass("select * from AMS.SR_Master");
		Console.WriteLine(classCode);
//		
		//Console.WriteLine(conn.GenerateAllTables());
