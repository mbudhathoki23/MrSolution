...
IF OBJECT_ID('CRM.UserRoleGroup') IS NULL BEGIN
    ...
    CREATE UNIQUE CLUSTERED INDEX [IX_UserRoleGroup]
    ON [CRM].[UserRoleGroup]([GroupDesc] ASC)
...
IF OBJECT_ID('CRM.LoginUserInfo') IS NULL BEGIN
    ...
    CREATE UNIQUE NONCLUSTERED INDEX [IX_LoginUserInfo]
    ON [CRM].[LoginUserInfo]([UserName] ASC)
    WITH(PAD_INDEX=OFF, STATISTICS_NORECOMPUTE=OFF, SORT_IN_TEMPDB=OFF, IGNORE_DUP_KEY=OFF, DROP_EXISTING=OFF, ONLINE=OFF, ALLOW_ROW_LOCKS=ON, ALLOW_PAGE_LOCKS=ON);
END;
IF OBJECT_ID('CRM.LoginUserInfo') IS NULL BEGIN
    ...
    CREATE UNIQUE NONCLUSTERED INDEX [IX_CompanyInfo]
    ON [CRM].[CompanyInfo]([CompanyName] ASC)
    WITH(PAD_INDEX=OFF, STATISTICS_NORECOMPUTE=OFF, SORT_IN_TEMPDB=OFF, IGNORE_DUP_KEY=OFF, DROP_EXISTING=OFF, ONLINE=OFF, ALLOW_ROW_LOCKS=ON, ALLOW_PAGE_LOCKS=ON);
