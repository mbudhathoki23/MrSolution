...
namespace PrintControl.PrintDesign.Sales_Invoice {
    ...
    public class SalesInvoiceA4half : ReportClass {
        
        public SalesInvoiceA4half() {
        }
        
        public override string ResourceName {
            get {
                return "SalesInvoiceA4half.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "PrintControl.PrintDesign.Sales Invoice.SalesInvoiceA4half.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesInvoiceA4half : Component, ICachedReport {
        
        public CachedSalesInvoiceA4half() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesInvoiceA4half rpt = new SalesInvoiceA4half();
            rpt.Site = this.Site;
            return rpt;
        }
