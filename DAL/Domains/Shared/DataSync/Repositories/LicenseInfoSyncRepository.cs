...
public class LicenseInfoSyncRepository(DbSyncRepoInjectData injectData) : DbSyncRepositoryBase(injectData), IDataSyncRepository<LicenseInfo>
{
    ...
    {
        return await GetUnSynchronizedDataAsync<LicenseInfo>();
    }
