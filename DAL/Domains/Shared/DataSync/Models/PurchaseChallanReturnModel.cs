...
public class PurchaseChallanReturnModel : BaseSyncData
{
    ...
    public List<PurchaseChallanReturnDetailsModel> PurchaseChallanReturnDetailsModels { get; set; }
    public List<PurchaseChallanReturnTermModel> PurchaseChallanReturnTermModels { get; set; }
}