...
public class PurchaseInvoiceModel : BaseSyncData
{
    ...
    public List<PurchaseInvoiceDetailsModel> PurchaseInvoiceDetailsModels { get; set; }
    public List<PurchaseInvoiceTermModel> PurchaseInvoiceTermModels { get; set; }
