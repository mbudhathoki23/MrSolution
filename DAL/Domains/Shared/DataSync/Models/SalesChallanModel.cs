...
public class SalesChallanModel : BaseSyncData
{
    ...
    public DateTime? QOT_Date { get; set; }
    ...
    public List<SalesChallanDetailsModel> SalesChallanDetailsModels { get; set; } = new();
    public List<SalesChallanTermModel> SalesChallanTermModels { get; set; } = new();
    public List<SalesChallanMasterOtherDetailsModel> salesChallanMasterOtherDetailsModels { get; set; } = new();
}