...
public class PurchaseInvoiceDetailsModel : BaseSyncData
{
    ...
    public int? PO_Sno { get; set; }
    public string? PC_Invoice { get; set; }
    public int? PC_SNo { get; set; }
    ...
    public long? P_Ledger { get; set; }
    public long? PR_Ledger { get; set; }
    ...
    public decimal TaxExempted_Amount { get; set; }
