...
public class PurchaseOrderModel : BaseSyncData
{
    ...
    public DateTime? PIN_Date { get; set; }
    public string? PQT_Invoice { get; set; }
    public DateTime? PQT_Date { get; set; }
    ...
    public List<PurchaseOrderTermModel> PurchaseOrderTermModels { get; set; }
}