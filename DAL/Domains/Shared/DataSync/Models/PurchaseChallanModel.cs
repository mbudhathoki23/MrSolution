...
public class PurchaseChallanModel : BaseSyncData
{
    public string PC_Invoice { get; set; }
    ...
    public List<PurchaseChallanDetailsModel> PurchaseChallanDetailsModels { get; set; }
    public List<PurchaseChallanTermModel> PurchaseChallanTermModels { get; set; }
}