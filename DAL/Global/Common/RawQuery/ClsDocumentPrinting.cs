...
public class ClsDocumentPrinting
{
    ...
    public DataTable GetPrintVoucherName(string module)
    {
        ...
        try
        {
            ...
            //cmdString += module.Equals("SB") || module.Equals("POS") || module.Equals("SR") ? " AND Module in ('SB','ATI','POS','SR')" : $" AND Module ='{module}' ";
            cmdString += module.Equals("SB") ? " AND Module in ('SB','ATI','POS')" : $" AND Module ='{module}' ";
            //cmdString += $" AND Module ='{module}' ";
