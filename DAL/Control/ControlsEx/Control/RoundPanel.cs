...
public sealed class RoundPanel : GroupBox
{
    public RoundPanel()
    {
        DoubleBuffered = true;
        TitleBackColor = Color.DarkSlateBlue;
        TitleForeColor = Color.White;
        TitleFont = new Font("Bookman Old Style", 12, FontStyle.Regular);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        using var path = GetRoundRectangleGraphicsPath(ClientRectangle, Radious);
    ...
    private static GraphicsPath GetRoundRectangleGraphicsPath(Rectangle b, int r)
    {
