...
namespace DatabaseModule.CustomEnum;
...
public enum EntryModule
{
    ...
    [Description("RECEIPT/PAYMENT VOUCHER")] RPV = 6,
    [Description("DEBIT NOTE")] DN = 7,
    [Description("CREDIT NOTE")] CN = 8,
    [Description("PURCHASE INDENT")] PIN = 9,
    [Description("PURCHASE ORDER")] PO = 10,

    [Description("PURCHASE ORDER CANCELLATION")] POC = 11,
    [Description("PURCHASE CHALLAN")] PC = 12,

    [Description("PURCHASE CHALLAN CANCELLATION")] PCC = 13,

    [Description("PURCHASE QUALITY CONTROL")] PQC = 14,
    [Description("PURCHASE INVOICE")] PB = 15,

    [Description("PURCHASE ADDITIONAL INVOICE")] PAB = 16,

    [Description("PURCHASE RETURN INVOICE")] PR = 17,

    [Description("PURCHASE EXPIRY/BREAKAGE")] PEB = 18,

    [Description("SALES QUOTATION")] SQ = 19,

    [Description("SALES QUOTATION CANCELLATION")] SQC = 20,
    ...
    [Description("SALES INVOICE CANCELLATION")] SBC = 27,
    [Description("RESTAURANT INVOICE")] RSB = 28,

    [Description("RESTAURANT INVOICE CANCELLATION")] RSBC = 29,
    [Description("POINT OF SALES")] POS = 30,

    [Description("ABBREVIATED TAX INVOICE")] ATI = 31,

    [Description("SALES ADDITIONAL INVOICE")] SAB = 32,
    [Description("SALES RETURN")] SR = 33,

    [Description("SALES RETURN CANCELLLATION")] SRC = 34,
    ...
    [Description("INVENTORY ISSUE RETURN")] MIR = 41,
    [Description("INVENTORY RECEIVE")] MR = 42,

    [Description("INVENTORY RECEIVE RETURN")] MRR = 43,
    [Description("PRODUCT MEMO")] IBOM = 44,
    [Description("RAW MATERIAL ISSUE")] RMI = 45,

    [Description("RAW MATERIAL ISSUE RETURN")] RMIR = 46,

    [Description("FINISHED GOODS RECEIVE")] FGR = 47,

    [Description("FINISHED GOODS RECEIVE RETURN")] FGRR = 48,
