...
namespace DatabaseModule.DataEntry.SalesMaster.SalesQuotation;

public class SQ_Master : BaseSyncData
{
    public string SQ_Invoice { get; set; }
    ...
    public string Ref_VMiti { get; set; }
    ...
    public string IND_Invoice { get; set; }
